...
// Route::delete('/user/delete_user/{id}', [UserController::class, 'delete'])->name('user.delete');
...
// Route::delete('/produk/delete_produk/{id}', [ProdukController::class, 'delete'])->name('produk.delete');
